...
const Nav = ({ setView }) => {
  ...
  return (
    <nav className="flex items-center justify-between bg-[#364153] px-6 py-4 shadow-md h-[80px]">
      ...
      <div className='flex flex-row gap-3 text-white hover:text-shadow-gray-500 hover:text-shadow-[2px_2px_1px] transition-shadow'>
        ...
        <h2 className="sm:text-2xl text-[15px] font-bold  content-center">Gino Cocina</h2>
      </div>
      <Modal
        Setstate={setView}
      />
...
const Modal = ({ Setstate }) => {
  ...
  return (
    ...
    <div className='relative'>
      <button className='md:hidden text-black hover:text-white cursor-pointer' onClick={menu}>
        <svg xmlns="http://www.w3.org/2000/svg" fill='currentColor' viewBox="0 0 50 50" width="20px" height="20px"><path d="M 0 7.5 L 0 12.5 L 50 12.5 L 50 7.5 Z M 0 22.5 L 0 27.5 L 50 27.5 L 50 22.5 Z M 0 37.5 L 0 42.5 L 50 42.5 L 50 37.5 Z" /></svg>
      </button>
      <div className={`fixed top-0 right-0 h-full w-40 bg-[#364153] shadow-2xl transform
        ${isOpenmenu ? `translate-x-0` : `translate-x-full`} transition-transform duration-150 ease-in-out z-50`}>
        <div className='flex flex-col justify-end p-4 gap-y-5 '>
          <button className='cursor-pointer' onClick={menu}>
            <svg fill="white" width="25px" height="25px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
              <title>cancel</title>
